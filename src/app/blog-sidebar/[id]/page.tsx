...
const BlogSidebarPage = async ({ params }: Params) => {
  const response = await fetchBlogData(); // response нь { data: [...] } байж магад
  const allBlogs = response.data; // data-г авна
  const blog = allBlogs.find((b: any) => b.id.toString() === params.id);
            ...
            <div className="mx-auto w-full px-4 lg:w-8/12">
              <div>
                    ...
                    <div className="mb-5 mr-10 flex items-center">
                      ...
                      <div className="w-full">
                        <span className="mb-1 text-base font-medium text-body-color">
                          Нийтэлсэн: <span> {blog.author}</span>
                        </span>
                      </div>
                    </div>
                ...
                <div>
                  ...
                  <ul className="mb-10 list-inside text-center  text-body-color">
                    <li className="mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg">
                      Танд болон танай байгууллагад it-гийн асуудал тулгараад
                      байгаа юм биш биз....
                    </li>
                    <li className="mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg">
                      Тэгвэл танд найдвартай хурдан шуурхай баг хамт олон
                      үйлчлэхэд бэлэн байна.
                    </li>
                    <li className="mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg">
                      Манай компаний үйл ажиллагаатай танилцахыг хүсвэл info гэж
                      коммент хэсэгт үлдээх эсвэл доорх вэб холбоосоор орж
                      танилцана уу.👇
                    </li>
                    <li className="mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg">
                      Баярлалаа!
